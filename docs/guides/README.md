...
- [Embedding the Core](./embedding-the-core.md) — manually assemble, initialize, drive, reset, and recompose a CHIP-8 machine using the public Core API, including Classic CHIP-8, CHIP-48, and SUPER-CHIP profiles, machine characteristics, `instructionSet`, shared-instruction `quirks`, display specifications, font resources, `ExitState`, and persistent `RplFlags`.
